...
export const MODULES = {
    ...
    s3: [
        { key: "algo", name: "Algo", hasTP: true, coef: 3, credit: 6 },
        { key: "archi", name: "Archi", hasTP: true, coef: 3, credit: 5 },
        { key: "tg", name: "TG", coef: 2, credit: 4 },
        { key: "si", name: "SI", coef: 3, credit: 5 },
        { key: "eng", name: "English", single: true, coef: 1, credit: 2 },
        { key: "mn", name: "MN", coef: 2, credit: 4 },
        { key: "lm", name: "LM", coef: 2, credit: 4 },
    ],
    s4: [
        { key: "os", name: "OS", hasTP: true, coef: 3, credit: 5 },
        { key: "tl", name: "TL", hasTP: true, coef: 2, credit: 4 },
        { key: "rc", name: "RC", hasTP: true, coef: 3, credit: 6 },
        { key: "bd", name: "BD", hasTP: true, coef: 3, credit: 5 },
        { key: "eng", name: "English", single: true, coef: 1, credit: 2 },
        { key: "poo", name: "POO", tpOnly: true, coef: 2, credit: 4 },
        { key: "web", name: "Web", tpOnly: true, coef: 2, credit: 4 },
    ],
    s5: [
